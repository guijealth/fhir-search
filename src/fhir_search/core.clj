...
(comment
  ...
  (parse-query "_has:Observation:patient._has:AuditEvent:entity:agent=MyUserId")
  (parse "/Patient?_has:Observation:patient._has:AuditEvent:entity:agent=MyUserId&general-practitioner:PractitionerRole.practitioner:Practitioner.name:contains=John&organization=Organization/909823472760")
